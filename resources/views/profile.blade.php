    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="btn btn-sb rounded-circle me-3 mt-1" id="enable-profile" onclick="enableForm(this, 'disable-profile', 'profile-form')"><i class="fa fa-pencil fa-sm"></i></button>
