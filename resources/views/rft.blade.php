    ...
    <div class="col-md-4">
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <input type="text" class="qty-input" id="rft-input" value="1">
                <div class="d-flex justify-content-between gap-1 mt-3">
                    <button class="btn btn-danger w-50 fs-3" id="decrement" onclick="decrement('rft-input')">-1</button>
                    <button class="btn btn-success w-50 fs-3" id="increment" onclick="increment('rft-input')">+1</button>
                </div>
            </div>
        </div>
    </div>
